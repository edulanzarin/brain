...
É a base de qualquer sistema/automação sobre o Questor ([[Navetech Hub]] e futuros). Entender estas convenções evita redescobrir o schema tabela a tabela. Para tabelas gigantes, ver [[Agregar antes de juntar em tabelas gigantes no Postgres]].
