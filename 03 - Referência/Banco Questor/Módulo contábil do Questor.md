...
Base de qualquer relatório contábil (balancete, DRE, razão, livro diário) e da futura seção Contábil do [[Questor BI]]. O `codigooriglctoctb` conecta este módulo a folha, fiscal, financeiro e patrimônio.
