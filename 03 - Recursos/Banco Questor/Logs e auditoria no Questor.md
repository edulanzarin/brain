...
Para "quem lançou esta nota / este lançamento contábil", leia essas colunas direto na tabela do dado — sem tocar em `loggeral`. (Foi assim que o [[Questor BI]] fez a análise de quem lançou a nota.)
