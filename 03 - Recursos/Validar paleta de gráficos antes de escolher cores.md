---
tags: [tipo/atomica, dev/frontend, design, conceito, projeto/questor-bi]
criado: 2026-07-18
---
...
Ao fazer dashboards ([[Questor BI]]), a ordem certa é: primeiro escolher a **forma** do gráfico pelo trabalho do dado (magnitude, identidade, comparação), e a **cor por último**. As cores categóricas devem ser atribuídas em ordem fixa (nunca cicladas) e a paleta passar por checagens objetivas:
