...
Verificado com sessão real nas duas rotas e nas duas telas (Questor inacessível, fallback e aviso vistos funcionando), mais tsc, eslint, 89 testes e `next build`. Branch `feat/produtividade-no-nexo`, merge ff na `main` + push.
