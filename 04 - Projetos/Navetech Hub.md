...
- **Produtividade** (`/fiscal/produtividade`): **seis** abas medindo o trabalho do time fiscal — Lançamentos, Impostos, Atraso, Carteira, Tempo e **No Nexo**. Refeita em ago/2026 (seção própria abaixo); até então era uma tela só, de notas lançadas, e recortava pela data errada. As cinco primeiras leem o Questor; a sexta lê a trilha do próprio app.
