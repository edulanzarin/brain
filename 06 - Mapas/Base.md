...
- [[Quando o passado importa, o estado atual é a última linha do histórico]] — "com quem está" não é coluna ao lado do histórico; o "de onde veio" é a linha anterior, linha nova não entra no meio, a transação trava a entidade, o que vem de fora congela na linha, e depois do primeiro uso o fim é uma baixa, não um apagar.
...
- [[Substituição global se decide membro a membro, não pelo nome da família]] — nome comum não é papel comum: antes de trocar tudo que casa com um nome, enumere o que ele pega e deixe de fora quem carrega significado em vez de forma. O sintoma engana porque é assimétrico — 95% funciona de primeira e o resto não fica feio, some.
...
- [[Especificidade se mede pelo que o campo distingue, não pelo tamanho do termo]] — com um campo de tipo (que se repete) e um de identidade (que muda), o termo curto no segundo ganha do longo no primeiro; campo novo no casamento não apaga regra velha, e o termo sugerido erra para o lado estreito, que deixa pendência em vez de conta errada calada.
...
- [[Falta de registro só prova algo dentro da janela em que a fonte era alimentada]] — "sem recibo, não gozou" e "sem demissão, está ativo" são a mesma inferência; antes da primeira e depois da última atividade da entidade, o silêncio da tabela não diz nada. As pontas saem do comportamento, e o que fica fora da janela vira contador à parte.
- [[O indicador de ciclo fala do último ciclo encerrado, não do que está em curso]] — quando a prova de conclusão só chega depois de o ciclo fechar, medir o ciclo corrente mostra zero e parece diagnóstico; a unidade é o ciclo, o intervalo só escolhe quais, e avisar "recue o período" é passar a regra para quem lê.
